...

{
...

    {
        ...
        foreach (string line in readText)
        {
            ...
            entry._key = entries[1];
            entry._book = entries[1];
            entry._chapter = int.Parse(entries[3]);
            entry._verseStart = int.Parse(entries[0]);
            entry._verseEnd = int.Parse(entries[2]);
